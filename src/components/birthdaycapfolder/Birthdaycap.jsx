...
const Birthdaycap = () => {
    const [sampleimg, setsampleimg] = useState("/BirthdaycapImages/Birthdaysample/samplebirthday5.webp");
    ...
    const [activeCapUrl, setActiveCapUrl] = useState("/BirthdaycapImages/birthdaycap1.webp");
    const imageUrls = [
        "/BirthdaycapImages/Birthdaysample/samplebirthday1.webp",
        "/BirthdaycapImages/Birthdaysample/samplebirthday2.webp",
        "/BirthdaycapImages/Birthdaysample/samplebirthday3.webp",
        "/BirthdaycapImages/Birthdaysample/samplebirthday4.webp",
        "/BirthdaycapImages/Birthdaysample/samplebirthday5.webp"

    ];

    const handleCapClick = (url) => {
        setActiveCapUrl(url);
    };
    ...
    useEffect(() => {
        setTransformations(prev => ({
            ...prev,
            rotate: activeCapUrl === "/BirthdaycapImages/birthdaycap1.webp" ? -35 : -10,
        }));
    }, [activeCapUrl]);

    console.log(transformations.rotate, activeCapUrl)
    const studentDetail =
    ...
    return (
        <div>
            <div className="fullcontainer">
                <div className="forslider">
                    <div className="cap-container" ref={persImgContRef}>
                        <img src={activeCapUrl} alt="cap" className={`cap-bg ${activeCapUrl === "/BirthdaycapImages/birthdaycap2.webp"
                            ? "cap-bg2"
                            : ""
                            }`} />
                        {selectedImage && <img src={selectedImage} alt="user"
                            className={`user-img ${activeCapUrl === "/BirthdaycapImages/birthdaycap2.webp"
                                ? "user-img2"
                                : ""
                                }`}
                            style={{
                        ...
                        <svg className={`curved-name ${activeCapUrl === "/BirthdaycapImages/birthdaycap2.webp"
                            ? "curved-name2"
                            : ""
                            }`} width="250" height="65">
                            <defs>
                            ...
                            <use href="#text-curve" stroke="white" strokeWidth="31" fill="none" className={`curve-path ${activeCapUrl === "/BirthdaycapImages/birthdaycap2.webp"
                                ? "curve-path2"
                                : ""
                                }`} />
                    ...
                    <div className="cap-slider-wrapper">
                        <h4 style={{ margin: "10px" }}>Choose any One  <i
                        ...
                        <Slider {...settings}>
                            <div>
                                <img
                                    src="/BirthdaycapImages/birthdaycap1.webp"
                                    alt="Birthday Cap 1"
                                    className={`cap-photo ${activeCapUrl === "/BirthdaycapImages/birthdaycap1.webp"
                                        ? "cap-photo--active"
                                        : ""
                                        }`}
                                    onClick={() => handleCapClick("/BirthdaycapImages/birthdaycap1.webp")}
                                />
                            </div>
                            <div>
                                <img
                                    src="/BirthdaycapImages/birthdaycap2.webp"
                                    alt="Birthday Cap 2"
                                    className={`cap-photo ${activeCapUrl === "/BirthdaycapImages/birthdaycap2.webp"
                                        ? "cap-photo--active"
                                        : ""
                                        }`}
                                    onClick={() => handleCapClick("/BirthdaycapImages/birthdaycap2.webp")}
                                />
                            </div>
                        </Slider>
                        <strong>  DreamikAI: Personalized birthday party paper cap with kids cartoon photo and wishes(10nos)</strong>
            ...
            <div className="samplecap">

                <img src={sampleimg} alt="cap" width={"300px"} height={"300px"} />
                <div >
                    {imageUrls.map((url, index) => (
                        <img key={index} src={url} alt={`image-${index}`} onClick={() => { setsampleimg(url) }}
                            className={`samplecollections ${sampleimg === url ? "selectedsample" : ""}`}
                        />
                    ))}
                </div>
            </div>
