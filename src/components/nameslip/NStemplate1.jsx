  ...
  const handleAddToCart = async () => {
    ...
    if (persImgContRef.current) {
      try {
        ...
        // localStorage.removeItem('editedprice');
    ...
    <div className="personalizecontainer">
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv2")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv2" && (
          <div
            id="customizediv2"
            ref={(el) => (customizeDivRefs.current["customizediv2"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv2")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv2" && (
              <div
                id="namecustomizediv2"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv2"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv2")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv2" && (
              <div
                id="schoolnamecustomizediv2"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv2"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <button onClick={() => toggleCustomizeDiv("rollcustomizediv1")}> <img
              ...
              className="custamlogo"
            /></button>
          {activeCustomizeDiv === "rollcustomizediv2" && (
            <div id="rollcustomizediv2">
              <TransformControls
                onUpdateTransform={(type, value) =>
            ...
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv2")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "classcustomizediv2" && (
                <div
                  id="classcustomizediv2"
                  ref={(el) =>
                    (customizeDivRefs.current["classcustomizediv2"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              ...
              />
              <button
                onClick={() => toggleCustomizeDiv("sectioncustomizediv2")}
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "sectioncustomizediv2" && (
                <div
                  id="sectioncustomizediv2"
                  ref={(el) =>
                    (customizeDivRefs.current["sectioncustomizediv2"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
