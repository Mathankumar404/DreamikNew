    ...
    <div className="personalizecontainer">
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv4")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv4" && (
          <div
            id="customizediv4"
            ref={(el) => (customizeDivRefs.current["customizediv4"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv4")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv4" && (
              <div
                id="namecustomizediv4"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv4"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            />
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv4")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv4" && (
              <div
                id="schoolnamecustomizediv4"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv4"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div id="OD">
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv4")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "classcustomizediv4" && (
                <div
                  id="classcustomizediv4"
                  ref={(el) =>
                    (customizeDivRefs.current["classcustomizediv4"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              ...
              />
              <button
                onClick={() => toggleCustomizeDiv("sectioncustomizediv4")}
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "sectioncustomizediv4" && (
                <div
                  id="sectioncustomizediv4"
                  ref={(el) =>
                    (customizeDivRefs.current["sectioncustomizediv4"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("rollcustomizediv4")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
            ...
            <div className="img-cus" style={{ position: "relative" }}>
              ...
              <button /*onClick={() => toggleCustomizeDiv("subjectcustomizediv4")}*/
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "subjectcustomizediv4" && (
                <div
                  id="subjectcustomizediv4"
                  ref={(el) =>
                    (customizeDivRefs.current["subjectcustomizediv4"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
