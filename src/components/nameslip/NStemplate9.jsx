    ...
    <div className="personalizecontainer">
      <div className="pers-img-cont">
        <div ref={persImgContRef}>
          ...
          <img
            ...
            className={
              selectedLabel === "/image/waterlabel/4.png" ||
                selectedLabel === "/image/waterlabel/4.webp"
                ? "watermark-special"
                : "watermark3"
            }
          />
          <label
            className={`studentname-lab3 ${selectedLabel === "/image/waterlabel2.webp"
              ? "namelabel3-style-2"
              : selectedLabel === "/image/waterlabel1.webp"
                ? "namelabel3-style-1"
                : selectedLabel === "/image/waterlabel/4.webp"
                  ? "namelabel3-style-3"
                  : selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT01.webp" ||
                    selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT01.png"
                    || selectedLabel === "/image/waterlabel/FERT.png"
                    ? "namelabel3-style-4"
                    : selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT02.webp" ||
                      selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT02.webp"
                      ? "namelabel3-style-5"
                      : ""
              }`}
            style={{
              fontSize: `${nameTrans.fontSize * nameTrans.scale}px`,
          ...
          <label
            className={`schoolname-lab3 ${selectedLabel === "/image/waterlabel2.webp"
              ? "schoolnamelabel3-style-2"
              : selectedLabel === "/image/waterlabel1.webp"
                ? "schoolnamelabel3-style-1"
                : selectedLabel === "/image/waterlabel/4.webp"
                  ? "schoolnamelabel3-style-3"
                  : selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT01.webp" ||
                    selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT01.webp"
                    || selectedLabel === "/image/waterlabel/FERT.png"
                    ? "schoollabel3-style-4"
                    : selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT02.webp" ||
                      selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT02.webp"
                      ? "schoollabel3-style-5"
                      : ""
              }`}
            style={{
          ...
          <label
            ref={textRef}
            className={`subjectname-lab3 ${selectedLabel === "/image/waterlabel2.webp"
              ? "subjectnamelabel3-style-2"
              : selectedLabel === "/image/waterlabel1.webp"
                ? "subjectnamelabel3-style-1"
                : selectedLabel === "/image/waterlabel/4.webp"
                  ? "subjectnamelabel3-style-3"
                  : selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT01.webp" ||
                    selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT01.webp"
                    ...
                    ? "subjectnamelabel3-style-4"
                    : selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT01.webp" ||
                      selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT02.webp"
                      ? "subjectnamelabel3-style-5"
                      : ""
              }`}
            style={{
          ...
          <label
            className={`rollnu-lab3 ${selectedLabel === "/image/waterlabel2.webp"
              ? "rollnulabel3-style-2"
              : selectedLabel === "/image/waterlabel1.webp"
                ? "rollnulabel3-style-1"
                : selectedLabel === "/image/waterlabel/4.webp"
                  ? "rollnulabel3-style-3"
                  : selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT01.webp" ||
                    selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT01.webp"
                    ...
                    ? "rollnulabel3-style-4"
                    : selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT02.webp" ||
                      selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT02.webp"
                      ? "rollnulabel3-style-5"
                      : ""
              }`}
            style={{
          ...
          <label
            className={`sectionname-lab3 ${selectedLabel === "/image/waterlabel2.webp"
              ? "sectionnamelabel3-style-2"
              : selectedLabel === "/image/waterlabel1.webp"
                ? "sectionnamelabel3-style-1"
                : selectedLabel === "/image/waterlabel/4.webp"
                  ? "sectionnamelabel3-style-3"
                  : selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT01.webp" ||
                    selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT01.webp"
                    ...
                    ? "sectionnamelabel3-style-4"
                    : selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT02.webp" ||
                      selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT02.webp"
                      ? "sectionnamelabel3-style-5"
                      : ""
              }`}
            style={{
          ...
          <label
            className={`classname-lab3 ${selectedLabel === "/image/waterlabel2.webp"
              ? "classnamelabel3-style-2"
              : selectedLabel === "/image/waterlabel1.webp"
                ? "classnamelabel3-style-1"
                : selectedLabel === "/image/waterlabel/4.webp"
                  ? "classnamelabel3-style-3"
                  : selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT01.webp" ||
                    selectedLabel ===
                    "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT01.webp"
                    ...
                    ? "classnamelabel3-style-4"
                    : selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTRT02.webp" ||
                      selectedLabel ===
                      "/image/UTF frames lang DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHRT02.webp"
                      ? "classnamelabel3-style-5"
                      : ""
              }`}
            style={{
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv8")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv8" && (
          <div
            id="customizediv8"
            ref={(el) => (customizeDivRefs.current["customizediv8"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv8")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv8" && (
              <div
                id="namecustomizediv8"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv8"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            />
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv8")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv8" && (
              <div
                id="schoolnamecustomizediv8"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv8"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div id="OD">
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv8")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "classcustomizediv8" && (
                <div
                  id="classcustomizediv8"
                  ref={(el) =>
                    (customizeDivRefs.current["classcustomizediv8"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              ...
              />
              <button
                onClick={() => toggleCustomizeDiv("sectioncustomizediv8")}
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "sectioncustomizediv8" && (
                <div
                  id="sectioncustomizediv8"
                  ref={(el) =>
                    (customizeDivRefs.current["sectioncustomizediv8"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("rollcustomizediv3")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "rollcustomizediv3" && (
                <div
                  id="rollcustomizediv3"
                  ref={(el) =>
                    (customizeDivRefs.current["rollcustomizediv3"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus" style={{ position: "relative" }}>
              ...
              <button /*onClick={() => toggleCustomizeDiv("subjectcustomizediv8")}*/
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "subjectcustomizediv8" && (
                <div id="subjectcustomizediv8">
                  <TransformControls
                    onUpdateTransform={(type, value) =>
                      setsubjecttrans((prev) => ({
                        ...prev,
