...
const NSPersonalize = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "name") {
      setNameTrans((prev) => ({ ...prev, fontSize: newFontSize + 7 }));
    ...
    <div className="personalizecontainer">
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv7")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv7" && (
          <div
            id="customizediv7"
            ref={(el) => (customizeDivRefs.current["customizediv7"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv7")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv7" && (
              <div
                id="namecustomizediv7"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv7"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            />
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv7")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv7" && (
              <div
                id="schoolnamecustomizediv7"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv7"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div id="OD">
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv7")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "classcustomizediv7" && (
                <div
                  id="classcustomizediv7"
                  ref={(el) =>
                    (customizeDivRefs.current["classcustomizediv7"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              ...
              />
              <button
                onClick={() => toggleCustomizeDiv("sectioncustomizediv7")}
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "sectioncustomizediv7" && (
                <div
                  id="sectioncustomizediv7"
                  ref={(el) =>
                    (customizeDivRefs.current["sectioncustomizediv7"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("rollcustomizediv7")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "rollcustomizediv7" && (
                <div
                  id="rollcustomizediv7"
                  ref={(el) =>
                    (customizeDivRefs.current["rollcustomizediv7"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus" style={{ position: "relative" }}>
              ...
              <button /*onClick={() => toggleCustomizeDiv("subjectcustomizediv7")}*/
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "subjectcustomizediv7" && (
                <div
                  id="subjectcustomizediv7"
                  ref={(el) =>
                    (customizeDivRefs.current["subjectcustomizediv7"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
                    ...
                    fontSize={subjecttrans.fontSize * subjecttrans.scale}
                  />
                </div>
              )}
            </div>
