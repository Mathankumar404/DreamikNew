...
const NSPersonalize = () => {
  ...
  const [circleImage, setCircleImage] = useState(true);
  ...
  const [fontColor, setFontColor] = useState(editedproduct ? editedproduct.labels[0].fontColor : "#292d9e");
  const [fontFamily, setFontFamily] = useState(editedproduct ? editedproduct.labels[0].fontFamily : "Arial");
  const [quantity, setQuantity] = useState(parseInt(editedproduct?.quantity) || 1);
  ...
  const subjectsData = {
    "KG": [
      "English", "English CW", "English HW",
      "Hindi", "Hindi CW", "Hindi HW",
      "Maths", "Maths CW", "Maths HW",
      "Rhymes", "Story"
    ].sort(),

    "I-V std": [
      "Arts", "Computer", "Computer CW",
      "Drawing Note", "English", "English CW", "English HW",
      "EVS", "EVS CW", "EVS HW",
      "Hindi", "Hindi CW", "Hindi HW",
      "Language", "Language CW", "Language HW",
      "Maths", "Maths CW", "Maths HW",
      "Rough Note", "Science", "Science HW"
    ].sort(),
  ...
  const handleManualInputChange = (e) => {
    ...
    const regex = /^[A-Za-z0-9_\-\.!@#$%&*()\s\u0900-\u097F\u0B80-\u0BFF]{0,16}$/;
    ...
    <div className="personalizecontainer">
      <div className="pers-img-cont" >
        <div ref={persImgContRef}>
          <div className='stickerdiv'>
            <img
              src={editedproduct && editedproduct.source ? editedproduct.source : product.source}
              alt="productImage3"
          ...
          <img src={editedproduct && editedproduct.waterlabel ? editedproduct.waterlabel : selectedLabel} alt="waterlabel"
            className={selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.png" ||
              selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.webp"
              ? "watermark-special11" : "watermark11"


            } />
          <label
            className={`studentname-lab11 ${selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT01.webp"
              ? "namelabel11-style-2"
              : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.webp"
                ? "namelabel11-style-1"
                : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT04.webp"
                  ? "namelabel11-style-3"
                  : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT01.webp" ||
                    selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT01.webp" ||
                    selectedLabel === "/image/waterlabel/FELT.png"
                    ? "namelabel11-style-4"
                    : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT02.webp" ||
                      selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT02.webp"
                      ? "namelabel11-style-5"
                      : ""
              }`}
          ...
          <label
            ...
            className={`schoolname-lab11 ${selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT01.webp"
              ? "schoolnamelabel11-style-2"
              : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.webp"
                ? "schoolnamelabel11-style-1"
                : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT04.webp"
                  ? "schoolnamelabel11-style-3"
                  : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT01.webp" ||
                    selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT01.webp" ||
                    selectedLabel === "/image/waterlabel/FELT.png"
                    ? "schoolnamelabel11-style-4"
                    : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT02.webp" ||
                      selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT02.webp"

                      ? "schoolnamelabel11-style-5"
                      : ""
              }`}
            style={{
          ...
          <label
            ...
            ref={textRef}
            className={`subjectname-lab11 ${selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT01.webp"
              ? "subjectnamelabel11-style-2"
              : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.webp"
                ? "subjectnamelabel11-style-1"
                : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT04.webp"
                  ? "subjectnamelabel11-style-3"
                  : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT01.webp" ||
                    selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT01.webp" ||
                    selectedLabel === "/image/waterlabel/FELT.png"

                    ? "subjectnamelabel11-style-4"
                    : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT01.webp" ||
                      selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT02.webp"

                      ? "subjectnamelabel11-style-5"
                      : ""
              }`}
            style={{
          ...
          <label
            ...
            className={`rollnu-lab11 ${selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT01.webp"
              ? "rollnulabel11-style-2"
              : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.webp"
                ? "rollnulabel11-style-1"
                : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT04.webp"
                  ? "rollnulabel11-style-3"
                  : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT01.webp" ||
                    selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT01.webp" ||
                    selectedLabel === "/image/waterlabel/FELT.png"

                    ? "rollnulabel11-style-4"
                    : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT02.webp" ||
                      selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT02.webp"

                      ? "rollnulabel11-style-5"
                      : ""
              }`}
            style={{
          ...
          <label
            ...
            className={`sectionname-lab11 ${selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT01.webp"
              ? "sectionnamelabel11-style-2"
              : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.webp"
                ? "sectionnamelabel11-style-1"
                : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT04.webp"
                  ? "sectionnamelabel11-style-3"
                  : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT01.webp" ||
                    selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT01.webp" ||
                    selectedLabel === "/image/waterlabel/FELT.png"

                    ? "sectionnamelabel11-style-4"
                    : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT02.webp" ||
                      selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT02.webp"

                      ? "sectionnamelabel11-style-5"
          ...
          <label
            className={`classname-lab11 ${selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT01.webp"
              ? "classnamelabel11-style-2"
              : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT02.webp"
                ? "classnamelabel11-style-1"
                : selectedLabel === "/image/Rightpic Nameslips-Blank-Templates-v4-DreamikAI-Type2-Label-Rectangle-HD(1920 x 1080 px)/FERT04.webp"
                  ? "classnamelabel11-style-3"
                  : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT01.webp" ||
                    selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT01.webp" ||
                    selectedLabel === "/image/waterlabel/FELT.png"
                    ? "classnamelabel11-style-4"
                    : selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FTLT02.webp" ||
                      selectedLabel === "/image/UTF lang leftframe DreamikAIComics-Type2-Label-Rectangle-Image-v1-HD(1920 x 1080 px)/FHLT02.webp"

                      ? "classnamelabel11-style-5"
                      : ""
              }`}
            style={{
      ...
      <div className="controllize-container">
        ...
        <div id="imagebar">
          ...
          <button onClick={() => toggleCustomizeDiv("customizediv11")} style={{ width: "75px " }} >
            <img
        ...
        {activeCustomizeDiv === "customizediv11" && (
          <div id="customizediv11" ref={(el) => (customizeDivRefs.current["customizediv11"] = el)}
            tabIndex={-1}>
            <TransformControls
              onUpdateTransform={(type, value) => updateTransform(type, value, setTransformations)} div={"customizediv"}
            />
            ...
            <div style={{ display: 'flex' }}>
              <label htmlFor="circleImg" style={{ marginLeft: "8px", fontSize: "20px", fontWeight: "bold" }}>Circle Border</label> <input type="checkbox" id='circleImg' checked={circleImage} onChange={(e) => handleCircleBorder(e.target.checked)} />
              <label htmlFor="imageBorder" style={{ marginLeft: "8px", fontSize: "20px", fontWeight: "bold" }}>
                Image Border
              </label>
              <input
                type="checkbox"
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv11")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv11" && (
              <div id="namecustomizediv11" ref={(el) => (customizeDivRefs.current["namecustomizediv11"] = el)}
                tabIndex={-1}>
                <TransformControls
                  onUpdateTransform={(type, value) =>
                    type === "color" ? setNameTrans((prev) => ({ ...prev, [type]: value })) : setNameTrans((prev) => ({ ...prev, [type]: prev[type] + value }))
                  }
          ...
          <div>
            <input
              ...
              className="studentDetails"
            />
            <button onClick={() => toggleCustomizeDiv("schoolnamecustomizediv11")}>  <img
              src="/image/custamize.png"
              alt=""
              width={"25px"}
              className="custamlogo"
            /></button>
            {activeCustomizeDiv === "schoolnamecustomizediv11" && (
              <div id="schoolnamecustomizediv11" ref={(el) => (customizeDivRefs.current["schoolnamecustomizediv11"] = el)}
                tabIndex={-1}>
                <TransformControls
                  onUpdateTransform={(type, value) =>
                    type === "color" ? setschooltrans((prev) => ({ ...prev, [type]: value })) : setschooltrans((prev) => ({ ...prev, [type]: prev[type] + value }))
                  }
          ...
          <button id="otherdetails" onClick={handleotherDetails}>
            Other Details <br />(class,section or rollno edit)
          </button>
          <div id="OD">
            ...
            <div className='img-cus'>
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv11")}>  <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
                className="custamlogo"
              ...
              /></button>
              {activeCustomizeDiv === "classcustomizediv11" && (
                <div id="classcustomizediv11" ref={(el) => (customizeDivRefs.current["classcustomizediv11"] = el)}
                  tabIndex={-1}>
                  <TransformControls
                    onUpdateTransform={(type, value) =>
                      type === "color" ? setclasstrans((prev) => ({ ...prev, [type]: value })) : setclasstrans((prev) => ({ ...prev, [type]: prev[type] + value }))
                    }
            ...
            <div className='img-cus'>
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("sectioncustomizediv11")}> <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
                className="custamlogo"
              /></button>
              {activeCustomizeDiv === "sectioncustomizediv11" && (
                <div id="sectioncustomizediv11" ref={(el) => (customizeDivRefs.current["sectioncustomizediv11"] = el)}
                  tabIndex={-1}>
                  <TransformControls
                    onUpdateTransform={(type, value) =>
                      type === "color" ? setsectiontrans((prev) => ({ ...prev, [type]: value })) : setsectiontrans((prev) => ({ ...prev, [type]: prev[type] + value }))
                    }
            ...
            <div className='img-cus'>
              <input
                type="text"
                name="rollNumber"
                placeholder={`${selectedLabel === "/image/waterlabel/4.png" ? "Contact Number" : "Roll number"} `}
                value={studentDetails.rollNumber}
                onInput={handleInputChange}
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("rollcustomizediv11")}> <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
                className="custamlogo"
              /></button>
              {activeCustomizeDiv === "rollcustomizediv11" && (
                <div id="rollcustomizediv11" ref={(el) => (customizeDivRefs.current["rollcustomizediv11"] = el)}
                  tabIndex={-1}>
                  <TransformControls
                    onUpdateTransform={(type, value) =>
                      type === "color" ? setrollnotrans((prev) => ({ ...prev, [type]: value })) : setrollnotrans((prev) => ({ ...prev, [type]: prev[type] + value }))
                    }
            ...
            <div className="img-cus" style={{ position: "relative" }}>
                        ...
                        {subjectsData[group].map((subject, idx) => (
                          <div key={idx} className="sub-option-item">
                            <label className="subjectnames">
                              <input
                                type="checkbox"
                                checked={studentDetails.subject.includes(subject)}
                                onChange={(e) =>
                                  handleCheckboxChange("Custom", subject, e.target.checked)
                                }
                                disabled={
                  ...
                  <div className="option-group">
                    ...
                    <div className="sub-options">
                      {manualSubjects.length > 0 ? (
                        ...
                        <div style={{ padding: "5px", fontStyle: "italic" }}>No custom subjects yet</div>
                      )}
                    </div>
                  </div>
              ...
              <button /*onClick={() => toggleCustomizeDiv("subjectcustomizediv3")}*/> <img src="/image/custamize.png" alt="" className="custamlogo" width={"25px"} /></button>
          ...
          <div id="fontcenter">
            ...
            <br />
            <div>
              <h4 style={{ margin: "8px", fontSize: "16px", fontWeight: "bold" }}>Pick color for all text:</h4>
            ...
            <div id="type">
              <h3>Type</h3>
              <br />
              <button id="normal" ref={normalRef} onClick={normal} ><h4>Matte</h4></button>
              <button id="glossy" ref={glossyRef} onClick={glossy} ><h4>Glossy</h4></button>
