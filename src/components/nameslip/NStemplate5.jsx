    ...
    <div className="personalizecontainer">
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv5")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv5" && (
          <div
            id="customizediv5"
            ref={(el) => (customizeDivRefs.current["customizediv5"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv5")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv5" && (
              <div
                id="namecustomizediv5"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv5"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            />
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv5")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv5" && (
              <div
                id="schoolnamecustomizediv5"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv5"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div id="OD">
            ...
            className="studentDetails"
          />
          <button onClick={() => toggleCustomizeDiv("rollcustomizediv1")}> <img
              src="/image/custamize.png"
              width={"25px"}
              alt=""
              className="custamlogo"
            /></button>
          {activeCustomizeDiv === "rollcustomizediv1" && (
            <div id="rollcustomizediv1">
              <TransformControls
                onUpdateTransform={(type, value) =>
            ...
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv1")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "classcustomizediv1" && (
                <div
                  id="classcustomizediv1"
                  ref={(el) =>
                    (customizeDivRefs.current["classcustomizediv1"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              ...
              />
              <button
                onClick={() => toggleCustomizeDiv("sectioncustomizediv1")}
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "sectioncustomizediv1" && (
                <div
                  id="sectioncustomizediv1"
                  ref={(el) =>
                    (customizeDivRefs.current["sectioncustomizediv1"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus" style={{ position: "relative" }}>
              ...
              <button /*onClick={() => toggleCustomizeDiv("subjectcustomizediv5")}*/
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "subjectcustomizediv5" && (
                <div
                  id="subjectcustomizediv5"
                  ref={(el) =>
                    (customizeDivRefs.current["subjectcustomizediv5"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
