  ...
  {loadingimage && (
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv6")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv6" && (
          <div
            id="customizediv6"
            ref={(el) => (customizeDivRefs.current["customizediv6"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv6")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv6" && (
              <div
                id="namecustomizediv6"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv6"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            />
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv6")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv6" && (
              <div
                id="schoolnamecustomizediv6"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv6"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div id="OD">
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv6")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "classcustomizediv6" && (
                <div
                  id="classcustomizediv6"
                  ref={(el) =>
                    (customizeDivRefs.current["classcustomizediv6"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              ...
              />
              <button
                onClick={() => toggleCustomizeDiv("sectioncustomizediv6")}
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "sectioncustomizediv6" && (
                <div
                  id="sectioncustomizediv6"
                  ref={(el) =>
                    (customizeDivRefs.current["sectioncustomizediv6"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("rollcustomizediv6")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "rollcustomizediv6" && (
                <div
                  id="rollcustomizediv6"
                  ref={(el) =>
                    (customizeDivRefs.current["rollcustomizediv6"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus" style={{ position: "relative" }}>
              ...
              <button /*onClick={() => toggleCustomizeDiv("subjectcustomizediv6")}*/
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "subjectcustomizediv6" && (
                <div
                  id="subjectcustomizediv6"
                  ref={(el) =>
                    (customizeDivRefs.current["subjectcustomizediv6"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
