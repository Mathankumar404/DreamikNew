    ...
    <div className="personalizecontainer">
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv3")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv3" && (
          <div
            id="customizediv3"
            ref={(el) => (customizeDivRefs.current["customizediv3"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv3")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv3" && (
              <div
                id="namecustomizediv3"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv3"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            />
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv3")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv3" && (
              <div
                id="schoolnamecustomizediv3"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv3"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div id="OD">
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("classcustomizediv3")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "classcustomizediv3" && (
                <div
                  id="classcustomizediv3"
                  ref={(el) =>
                    (customizeDivRefs.current["classcustomizediv3"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
            ...
            <div className="img-cus">
              ...
              />
              <button
                onClick={() => toggleCustomizeDiv("sectioncustomizediv3")}
              >
                {" "}
                <img
                  src="/image/custamize.png"
              ...
              {activeCustomizeDiv === "sectioncustomizediv3" && (
                <div
                  id="sectioncustomizediv3"
                  ref={(el) =>
                    (customizeDivRefs.current["sectioncustomizediv3"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
