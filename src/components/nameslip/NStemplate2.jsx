  ...
  const removeBackground = async () => {
    ...
    try {
      const response = await fetch("https://api.remove.bg/v1.0/removebg", {
        method: "POST",
        headers: {
          "X-Api-Key": "ZhuQT1H1qGc6Jb6QRKXdG4Fk", // Replace with your actual API key
        },
        body: formData,
      });
    ...
    <div className="personalizecontainer">
      ...
      <div className="controllize-container">
        <div id="imagebar">
          ...
          <button
            onClick={() => toggleCustomizeDiv("customizediv1")}
            style={{ width: "75px " }}
          >
            <img
        ...
        {activeCustomizeDiv === "customizediv1" && (
          <div
            id="customizediv1"
            ref={(el) => (customizeDivRefs.current["customizediv1"] = el)}
            tabIndex={-1}
          >
            <TransformControls
        ...
        <div className="student-details">
          <div>
            ...
            />
            <button onClick={() => toggleCustomizeDiv("namecustomizediv1")}>
              <img
                src="/image/custamize.png"
                width={"25px"}
                alt=""
            ...
            {activeCustomizeDiv === "namecustomizediv1" && (
              <div
                id="namecustomizediv1"
                ref={(el) =>
                  (customizeDivRefs.current["namecustomizediv1"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div>
            ...
            />
            <button
              onClick={() => toggleCustomizeDiv("schoolnamecustomizediv1")}
            >
              {" "}
              <img
                src="/image/custamize.png"
            ...
            {activeCustomizeDiv === "schoolnamecustomizediv1" && (
              <div
                id="schoolnamecustomizediv1"
                ref={(el) =>
                  (customizeDivRefs.current["schoolnamecustomizediv1"] = el)
                }
                tabIndex={-1}
              >
                <TransformControls
          ...
          <div id="OD">
            ...
            <div className="img-cus">
              <input
                ...
                className="studentDetails"
              />
              <button onClick={() => toggleCustomizeDiv("rollcustomizediv1")}>
                {" "}
                <img
                  src="/image/custamize.png"
                  width={"25px"}
              ...
              {activeCustomizeDiv === "rollcustomizediv1" && (
                <div
                  id="rollcustomizediv1"
                  ref={(el) =>
                    (customizeDivRefs.current["rollcustomizediv1"] = el)
                  }
                  tabIndex={-1}
                >
                  <TransformControls
